...
###############################################################################
    ...
    meie_font = pygame.font.SysFont("Arial Black", 25)
###############################################################################
    # - subscene 1 -
...
###############################################################################
    ...
    scene_6 = "As you were getting close to the cafeteria you were working in, you`ve heard  noise of an ambulance passing nearby. 'So early in the morning?' - you've asked yorself."#continue
    ...
    while not gameExit:
        ...
        if display_subscene == 1:
            ...
            bg = pygame.image.load("morning.jpg")
            ...
            button("Ð¡ontinue", 100,500,600,50,green,bright_green, mouse_button, lambda:goto_subscene(10))
...
###########################################Mother ending
            ...
            blit_text(gameDisplay, scene_16_1_4_3, (20,20),meie_font)
            ...
            blit_text(gameDisplay, scene_17__9, (20,20),meie_font)
            ...
            blit_text(gameDisplay, scene_17__10, (20,20),meie_font)
            button("To be continued...", 100,500,600,50,green,bright_green, mouse_button, quitgame)
